    ...
    <div class="grid grid-cols-4 gap-2">
        @foreach ($statuses as $status)
            <button
                ...
                @class([
                    'px-3 py-2 flex flex-col rounded-xl border hover:border-blue-400 text-gray-700 cursor-pointer' => true,
                    'text-blue-600 border-2 border-blue-400' => $status['value'] === $selectedStatus,
                    'text-gray-700' => $status['value'] !== $selectedStatus,
                ])
            >
